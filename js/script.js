...
if(!isNaN(distance) && age>=0 && distance>=0){document.getElementById('distanza').innerHTML += "Distanza del percorso: " + distance + " km";
}

if(!isNaN(age) && distance>=0 && age>=0){document.getElementById('age').innerHTML += "La tua età è: " + age + " anni";
}
